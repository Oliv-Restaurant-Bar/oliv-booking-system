                    ...
                    <div className="bg-muted/30">
                      ...
                      >
                        {group.items.map((item, index) => (
                          <SortableAddonItem key={item.id} id={item.id}>
                            {({ attributes, listeners, isDragging }: any) => (
                              <div
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2">
                                    {(item as any).dietaryType && (item as any).dietaryType !== 'none' && (
                                      <DietaryIcon type={(item as any).dietaryType} size="sm" />
                                    )}
                                  ...
                                  {canManageAddons && (
                                    <>
                                      ...
                                      <button
                                        ...
                                        className="p-1.5 hover:bg-accent rounded-lg transition-colors text-destructive"
                                      >
                                        <Trash2 className="w-4 h-4" />
                                      </button>
                                    </>
