      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5 py-3 border-y border-border/50">
        ...
        {showDate && (
          <div className="flex items-center gap-1.5 text-muted-foreground min-w-0">
            ...
            <span className="text-[11px] font-medium truncate">{booking.event.date}</span>
          </div>
        )}
        ...
        <div className="flex items-center gap-1.5 text-muted-foreground min-w-0">
          ...
          <span className="text-[11px] font-medium truncate">{booking.event.time}</span>
        </div>
        ...
        <div className="flex items-center gap-1.5 text-muted-foreground min-w-0">
          ...
          <span className="text-[11px] font-medium truncate">
            {t('calendar.guests', { count: booking.guests })}
          </span>
        </div>
        ...
        {booking.event.location && (
          <div className="flex items-center gap-1.5 text-primary min-w-0">
            ...
            <span className="text-[11px] font-bold truncate">{booking.event.location}</span>
          </div>
        )}
      </div>
