...
async function generateTestEmails() {
  ...
  try {
    ...
    const smallBooking = {
      ...
      editSecret: "test-edit-secret-small",
      isLocked: false,
      ...
      plz: "8001",
      business: "Mustermann AG",
      occasion: "Geschäftliches Abendessen",
      reference: "REF-2024-001",
      paymentMethod: "ec_card" as const,
      useSameAddressForBilling: true,
      billingStreet: "Hauptstrasse 123",
      billingPlz: "8001",
  ...
  try {
    ...
    const largeBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-large",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
  ...
  try {
    ...
    const cancelledBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-cancelled",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
  ...
  try {
    ...
    const reminderBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-reminder",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
  ...
  try {
    ...
    const completedBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-completed",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
      ...
      lead: {
        ...
        contactEmail: "thomas.webber@example.ch",
  ...
  try {
    ...
    const noShowBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-noshow",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
      ...
      lead: {
        ...
        eventDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
        eventTime: "19:00",
        guestCount: 6,
        source: "website",
        status: "converted" as const,
  ...
  try {
    ...
    const declinedBooking = {
      ...
      termsAccepted: true,
      termsAcceptedAt: new Date(),
      editSecret: "test-edit-secret-declined",
      isLocked: false,
      lockedBy: null as string | null,
      lockedAt: null as Date | null,
      assignedTo: null as string | null,
